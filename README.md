...
CommonCore R6 targets Unity 2022.3. The last version to support Unity 2021 is 5.0.0 and the last version to support Unity 2020 is 4.1.2. CommonCore R7 will target Unity 6.3; R6 should work with Unity 6.0 but has not been tested.
